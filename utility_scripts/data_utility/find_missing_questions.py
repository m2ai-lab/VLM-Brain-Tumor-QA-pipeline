...
def argument_handler():
    ...
    parser.add_argument('--response_path', type=str, required=False, default="/scratch/group/CX000019_DS1/vlm-brain-mri/QApairs/finalized_ucsf_pdgm_pairs.csv")
    parser.add_argument('--ground_truth_path', type=str, required=False, default="/scratch/group/CX000019_DS1/vlm-brain-mri/QApairs/finalized_ucsf_pdgm_pairs.csv")
...
def main(args):
    ...
    for _,row in response_df.iterrows():
        ...
        answer = row['Answer']
        possible_questions = ground_truth_df[["Assigned ID" == assigned_id]]["Question"]
    ...
    for _,row in ground_truth_df.iterrows():
        if row["Question"] not in response_df["Question"].values:
            ...
            output_df.append(response_df.loc[response_df['Question'] == row["Question"]])
