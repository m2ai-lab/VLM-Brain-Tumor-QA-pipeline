...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MedGemma Text-Only Inference")
    parser.add_argument('--qa_path', type=str, default=_cfg.get("qa_path"))
    parser.add_argument('--output_path', type=str, default=_cfg.get("output_base", "") + "/MedGemma1.5/text_only_results.csv")
