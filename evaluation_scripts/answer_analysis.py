...
def argument_handler():
    ...
    parser.add_argument('--model_path', type=str, default="/scratch/group/CX000019_DS1/vlm-brain-mri/Qwen2.5-7B-Instruct", required=True, help="Path or Hugging Face model name")
